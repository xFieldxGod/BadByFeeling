...
function saveToFirebase() {
    firebase.database().ref('badmintonData').set({
        queue: queue,
        players: players,
...
function loadFromFirebase() {
    firebase.database().ref('badmintonData').once('value')
        .then(snapshot => {
            ...
            if (data) {
                ...
                isMatchInProgress = data.isMatchInProgress || false;
                renderList();
...
// Replace local storage functions with Firebase equivalents
